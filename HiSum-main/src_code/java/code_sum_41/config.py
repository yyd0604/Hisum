...
# train_data_name='gpt_train_data'
# valid_data_name='gpt_valid_data'
# test_data_name='gpt_test_data'
...
max_code_len=285     #285 321
# max_code_str_len=15
max_graph_size=395  #437 395
...
import os
from torch_geometric.nn import SAGEConv, GCNConv, GATConv,TransformerConv,DirGNNConv
#
emb_dims = 512  #################### 512
graph_gnn_layers=6    #################### 6
# code_att_layers=2   #################### 2
text_att_layers=6   #################### 6
train_batch_size=120    #################### 192 成功160
version='41a1'  ####################

model_name='newmodel_v{}_{}_{}_{}'.format(version,graph_gnn_layers,text_att_layers,emb_dims)
params = dict(model_dir=model_dir,
              model_name=model_name,
              model_id=None,
              emb_dims=emb_dims,
              graph_gnn_layers=graph_gnn_layers, #############2080*10
              graph_GNN=DirGNNConv,
              graph_gnn_aggr='mean',
              ...
              pred_batch_size=math.ceil(train_batch_size * 1),  #################### 2 1.25
