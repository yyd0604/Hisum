...
# train_data_name='train_data_sample'
# valid_data_name='valid_data_sample'
# test_data_name='test_data_sample'
...
import os
from torch_geometric.nn import SAGEConv, GCNConv, GATConv, TransformerConv, HANConv, DirGNNConv

#
emb_dims = 768  #################### 512
graph_gnn_layers=6    #################### 6 ！！！参数实验 8
# code_att_layers=2   #################### 2
text_att_layers=6   #################### 6
train_batch_size= 192   #################### 192  #50是成功的
version='41a1'  ####################
model_name='codescriber_v{}_{}_{}_{}_{}'.format(version,graph_gnn_layers,text_att_layers,emb_dims,'lmzq_dirGCN')
